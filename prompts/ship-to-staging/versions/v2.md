...
manual testing. Do NOT set the Linear status, post a proof comment, or
reconcile failure notices yet — that's the separate `staging-finalise` step,
run only after I confirm my manual testing.
