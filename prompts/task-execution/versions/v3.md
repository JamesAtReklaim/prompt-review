...
- Don't ask what the system already answers (repo rules, AGENTS.md, the issue/comments,
  docs/context, and Notion specs + precedent QA pages — the repo's docs-navigation rule
  points to these Notion hubs) — source those yourself. Notion is a first-class source,
  not just the in-repo docs.
